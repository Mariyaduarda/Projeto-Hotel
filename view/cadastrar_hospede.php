...
<head>
    ...
    <title>Cadastrar Hóspede - Palácio Lumière</title>
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            <header class="main-header">
                <h1><i class="fas fa-user-plus"></i> Cadastrar Hóspede</h1>
            </header>
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="preferencias" name="preferencias" 
                                  placeholder="Ex: Quarto silencioso, andar alto, vista para o mar..."><?= htmlspecialchars($_POST['preferencias'] ?? '') ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="observacoes" class="form-label">Observações</label>
                        <textarea class="form-control" id="observacoes" name="observacoes" 
                                  placeholder="Ex: Alergias, restrições alimentares, necessidades especiais..."><?= htmlspecialchars($_POST['observacoes'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="btn-group-actions">
                        <button type="submit" class="btn-primary-custom">
                            <i class="fas fa-save"></i> Cadastrar Hóspede
                        </button>
