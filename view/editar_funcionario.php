...
$cpfFormatado = $funcionario['documento'] ?? $funcionario['cpf'] ?? '';
$telefoneFormatado = $funcionario['telefone'] ?? '';
$cepFormatado = $funcionario['cep'] ?? '';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Editar Funcionário - Palácio Lumière</title>
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            <header class="main-header">
                <h1><i class="fas fa-edit"></i> Editar Funcionário</h1>
            </header>
                ...
                <form method="POST" action="">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="cargo" name="cargo">
                                    ...
                                    <option value="Camareira" <?= ($funcionario['cargo'] ?? '') == 'Camareira' ? 'selected' : '' ?>>Camareira</option>
                                    <option value="Seguranca" <?= ($funcionario['cargo'] ?? '') == 'Seguranca' ? 'selected' : '' ?>>Segurança</option>
                                    <option value="Manutencao" <?= ($funcionario['cargo'] ?? '') == 'Manutencao' ? 'selected' : '' ?>>Manutenção</option>
                                    <option value="Chef" <?= ($funcionario['cargo'] ?? '') == 'Chef' ? 'selected' : '' ?>>Chef</option>
                                    <option value="Garcom" <?= ($funcionario['cargo'] ?? '') == 'Garcom' ? 'selected' : '' ?>>Garçom</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="salario" name="salario"
                                       placeholder="R$ 0,00"
                                       value="<?= htmlspecialchars($salarioFormatado) ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="turno" name="turno">
                                    <option value="">Selecione...</option>
                                    <option value="Manha" <?= ($funcionario['turno'] ?? '') == 'Manha' ? 'selected' : '' ?>>Manhã</option>
                                    ...
                                    <option value="Integral" <?= ($funcionario['turno'] ?? '') == 'Integral' ? 'selected' : '' ?>>Integral</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="data_contratacao" name="data_contratacao"
                                       value="<?= htmlspecialchars($funcionario['data_contratacao'] ?? date('Y-m-d')) ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="endereco" name="endereco"
                                       value="<?= htmlspecialchars($funcionario['logradouro'] ?? '') ?>">
                            </div>
                        </div>
                    ...
                    <div class="btn-group-actions">
                        ...
                        <button type="button" class="btn-secondary-custom" 
                                ...
                                onclick="confirmarExclusao(<?= $id ?>, '<?= htmlspecialchars($funcionario['nome']) ?>')">
